...
import 'package:ireader_web/views/admin/parent/add_parent.dart';
import 'package:ireader_web/views/admin/parent/add_parent_dialog.dart';
import 'package:ireader_web/views/admin/parent/view_students.dart';
...
class _ManageParentsState extends State<ManageParents> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      drawer: isDesktop
          ? null
          : Drawer(child: AdminSidebar(activeRoute: AdminRoute.parents)),
      body: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          if (isDesktop) AdminSidebar(activeRoute: AdminRoute.parents),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                AdminTopHeader(
                  ...
                  pageSubtitle: 'Parent accounts and section assignments',
                ),
                Expanded(
                  ...
                  onTap: () {
                    ...
                    if (isMobile) {
                      ...
                      showDialog(
                        context: context,
                        barrierDismissible: false,
                        builder: (_) => AddParentDialog(parent: parent),
                      );
                    }
                  },
                  child: Container(
