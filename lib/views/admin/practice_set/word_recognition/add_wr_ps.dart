...
class AddWrPs extends StatefulWidget {
  final Section section;
  final SchoolYear schoolyear;
  const AddWrPs({super.key, required this.section, required this.schoolyear});

  @override
  State<AddWrPs> createState() => _AddWrPsState();
}
...
class _AddWrPsState extends State<AddWrPs> {
  ...
  Future<void> SaveWordRecognitionPracticeSet() async {
    ...
    try {
      ...
      final docRef = _firestore.collection("wordrecognitionpracticeset").doc();
              ...
              return Padding(
                ...
                child: isMobileS
                    ...
                    ? IconButton(
                        ...
                        color: Colors.blue,
                        tooltip: "Save Word Recognition Practice Set",
                        onPressed: _isLoading
                            ? null
                            : SaveWordRecognitionPracticeSet,
                      )
                    // 🔥 ICON + LABEL (Tablet/Desktop)
                    : ElevatedButton.icon(
                        icon: const Icon(Icons.save, size: 20),
                        label: const Text('Save Word Recognition Practice Set'),
        ...
        child: ListView(
          ...
          children: [
            Column(
              ...
              children: [
                Text(
                  "Word Recognition Practice Set Details",
                  style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
