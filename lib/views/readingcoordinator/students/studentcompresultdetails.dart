...
class RCcompresultdetails extends StatefulWidget {
  final CompAssessmentResult compResult;
  const RCcompresultdetails({super.key, required this.compResult});

  @override
  State<RCcompresultdetails> createState() => _RCcompresultdetailsState();
}

class _RCcompresultdetailsState extends State<RCcompresultdetails> {
