  ...
  Widget _buildWinnersWidget() {
    ...
    if (_selectedRangeYears.length >= 2) {
      ...
      if (lastIndP > firstIndP) {
        insight =
            "Reading performance shows an improving trend. Independent readers increased from "
        ...
        insight =
            "Reading performance shows a declining trend. Frustration level students increased from "
        ...
        insight =
            "Reading performance remains relatively stable across the selected years. Independent readers average "
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => const RCDashboard()),
                );
              },
            ),
            const SizedBox(height: 12),
            ListTile(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => const RCManageSchoolyearScreen(),
                  ),
                );
              },
            ),
